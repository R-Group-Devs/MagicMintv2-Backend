...
router.get('/campaign/allcampaigns/twitterpostid', campaignController.getAllCampaigns);
...
router.get('/campaign/getNFTPrototype/:handle', campaignController.getNFTPrototypeCreatedByUser)
